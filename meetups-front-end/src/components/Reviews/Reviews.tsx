        ...
        <div className="view reviews-view">
            ...
            <div className='show-old-reviews-area'>
                ...
                <h3 className='show-old-reviews-area__review-h3'>
                    <ul className='show-old-reviews-area__review-h3__reviewItems'>{reviewItems}</ul>{' '}
                </h3>
            </div>
            ...
            {newReview ? (
                ...
                <section className='show-Reviews-Area'>
                    <button className="writeReview" onClick={switchToNewReview}>Skriv recension</button>
                </section >
            )
            }
        </div>
